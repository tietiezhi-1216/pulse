...
const ResponsePaneActions = ({ item, collection, responseSize, selectedFormat, selectedTab, data, dataBuffer }) => {
  ...
  const gqlMenuItems = [
    {
      id: 'copy-response',
      label: t('RESPONSE_PANEL.COPY_RESPONSE'),
    ...
    },
    {
      ...
      label: t('RESPONSE_PANEL.DOWNLOAD_RESPONSE'),
    ...
    {
      id: 'clear-response',
      label: t('RESPONSE_PANEL.CLEAR_RESPONSE'),
    ...
    {
      id: 'change-layout',
      label: t('RESPONSE_PANEL.CHANGE_LAYOUT'),
  ...
  const menuItems = [
    ...
    {
      id: 'save-response',
      label: t('RESPONSE_PANEL.SAVE_RESPONSE'),
  ...
  return (
    <StyledWrapper className="response-pane-actions-wrapper">
      <div className="actions-dropdown">
        ...
        >
          <MenuIcon title={t('RESPONSE_PANEL.MORE_ACTIONS')} />
        </MenuDropdown>
      </div>
